		...
		<form class="d-none d-sm-inline-block">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Motoristas ClickTaxi</h1>
...
<br>
   ...
   <div class="row">
	 <div class="col-sm-12">
		 <a href="add-clicktaxi.php">
	  <button type="button" class="btn btn-primary mb-3" data-toggle="modal">Inserir Novo Motorista </button>
	  </a>
	 </div>
	...
	<div class="content">
	  <div class="row">
		<div class="col-md-12">
		  <div class="card">
			<div class="card-header">
			  <h4 class="card-title"> Tabela de Motoristas ClickTaxi</h4>
			</div>
			<div class="card-body">
			  ...
			  <!--LISTAR TODOS OS MOTORISTA CLICK TAXI-->
			  <?php

			  if(isset($_GET['buttonPesquisar']) and $_GET['txtpesquisar']!=''){
				$nome = $_GET['txtpesquisar'] . '%';
				$queryTabela = "SELECT * FROM `motoristaclicktaxi` where praca LIKE '$nome' order by nome asc";
			  }else{
			  ...
			  if($rowTabela < 0){
					...
					while($res_1 = mysqli_fetch_array($resultTabela)){
						  ...
						  <tr>
							...
							<td>
							  ...
							  edit-motoristaclicktaxi.php?func=edita&id=<?php
							  echo $id;
							  ?>
							  ">
                ...
                if($_SESSION['cargo_usuario'] == 'administrador' || $_SESSION['cargo_usuario'] == 'gerente'){
                 ...
                 ?>
							  ...
							  pages-clicktaxi.php?func=deleta&id=<?php
							  echo $id;
							  ?>
							  ">
   ...
   <!-- Modal content-->
	...
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title">Motoristas Click Taxi</h4>
...
<?php
  ...
  if(isset($_POST['button'])){
    ...
    $queryVerifica = "select * from motoristaclicktaxi where bi = '$bi'";
    ...
    $query = "INSERT INTO `motoristaclicktaxi`(`nome`, `telefone`, `endereco`, `email`, `bi`, `data`) VALUES ('$nome','$telefone','$endereco','$email','$bi',CURRENT_DATE)";
...
if(@$_GET['func'] == 'deleta'){
  $id = $_GET['id'];
  $query = "DELETE FROM motoristaclicktaxi where id = '$id'";
...
<?php 
  if(@$_GET['func'] == 'edita'){
    $id = $_GET['id'];
    $queryEdita = "select * from motoristaclicktaxi where id = '$id'";
...
if(isset($_POST['buttonEditar'])){
  ...
  if ($res_1['bi'] != $bi){
    ...
    $query_verificar = "select * from motoristaclicktaxi where bi = '$bi' ";
...
$query_editar = "UPDATE motoristaclicktaxi set nome = '$nome', telefone = '$telefone', endereco = '$endereco', email = '$email', bi = '$bi' where id = '$id' ";
