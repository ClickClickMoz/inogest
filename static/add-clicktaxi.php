          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Adicionar Novo Motorista ClickTaxi</h1>
							...
							<div class="card">
								...
								<div class="card-body">
									<form method="POST">
										...
										<div class="row">
										<div class="mb-3 col-md-6">
											<label class="form-label" for="inputAddress">Matricula do Carro</label>
											<input type="text" class="form-control" id="txtmatricula" name="txtmatricula" placeholder="Matricula do Carro" required>
										</div>
										</div>
										<div class="row">
										<div class="mb-3 col-md-6">
											<label class="form-label" for="txtcidade">Cor do Carro</label>
