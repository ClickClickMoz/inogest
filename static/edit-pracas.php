...
<?php 
  if(@$_GET['func'] == 'edita'){
    $id = $_GET['id'];
    $query = "select * from pracas where id = '$id'";
      ...
      <form method="POST">
										<div class="row">
											<div class="mb-3 col-md-6">
												...
												<input type="text" value="<?php echo $res_1['praca']; ?>" class="form-control" name="txtpraca" id="txtpraca" placeholder="Praça" required>
                                            </div>
										...
										<div class="row">
											<div class="mb-3 col-md-6">
                                                ...
                                                <option value="<?php echo $res_1['plataforma']; ?>"><?php echo $res_1['plataforma']; ?></option>      
...
$query_editar = "UPDATE pracas set praca = '$praca', provincia = '$provincia', plataforma = '$plataforma' where id = '$id' ";
