									...
									<form method="POST">
										<div class="row">
											<div class="mb-3 col-md-6">
												...
												<input type="text" class="form-control" name="txtusuario" id="txtusuario" placeholder="Usuário" required>
											</div>
										...
										<div class="row">
											<div class="mb-3 col-md-6">
												...
												<input type="text" class="form-control" id="txtsenha" name="txtsenha" placeholder="Palavra Passe" required>
											</div>
