		...
		<form class="d-none d-sm-inline-block">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Turnos EDC</h1>
...
<br>
   ...
   <div class="row">
	 <div class="col-sm-12">
		 <a href="add-fecharturno.php">
	  <button type="button" class="btn btn-primary mb-3" data-toggle="modal">Fechar Turno </button>
	  </a>
	 </div>
	...
	<div class="content">
	  <div class="row">
		<div class="col-md-12">
		  <div class="card">
			<div class="card-header">
			  <h4 class="card-title"> Registro Fecho Turno</h4>
			</div>
			<div class="card-body">
			  ...
			  if(isset($_GET['buttonPesquisar']) and $_GET['txtpesquisar']!=''){
				...
				$queryTabela = "SELECT * FROM `turnos` where funcionario LIKE '$nome' order by datar desc";
			  }else{
			  $queryTabela = "SELECT * FROM `turnos` order by id desc";
			  }
			  ...
			  if($rowTabela < 0){
				...
				<table class="table">
				  ...
				  <tbody>  
					...
					while($res_1 = mysqli_fetch_array($resultTabela)){
						  $id = $res_1["id"];
						  $nome  =  $res_1["funcionario"];
						  $hora  =  $res_1["hora"];
						  $ligeiropesado  =  $res_1["ligeiropesado"];
						  $total = $res_1["total"];
						  $profissional  =  $res_1["profissional"];
						  $metaatingida  =  $res_1["metaatingida"];
						  $pendentes = $res_1["pendentes"];
						  $data  =  $res_1["datar"];
						  ...
						  <tr>
							<td><?php echo $nome; ?></td>
							<td><?php echo $ligeiropesado; ?></td>
							<td><?php echo $profissional; ?></td>
							<td><?php echo $total; ?></td>
							<td><?php echo $pendentes; ?></td>
							<td><?php echo $data2; ?></td>
							<td><?php echo $hora; ?></td>
							<td><?php echo $metaatingida; ?></td>
							<td>
							  <a class="btn btn-info" href="
							  edit-motoristaclicktuk.php?func=edita&id=<?php
							  echo $id;
							  ?>
							  ">
                ...
                if($_SESSION['cargo_usuario'] == 'administrador' || $_SESSION['cargo_usuario'] == 'gerente'){
                 ...
                 ?>
							  ...
							  pages-blank.php?func=deleta&id=<?php
							  echo $id;
							  ?>
							  ">
   ...
   <!-- Modal content-->
	...
	<div class="modal-content">
	  <div class="modal-header">
		...
		<h4 class="modal-title">Registro Fecho Turno</h4>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-left">
							<p class="mb-0">
								<a href="indexx.html" class="text-muted"><strong>InoGest</strong></a> &copy;
							</p>
						</div>
...
<?php
  ...
  if(isset($_POST['button'])){
    ...
    $query = "INSERT INTO `motoristaclicktuk`(`nome`, `telefone`, `endereco`, `email`, `bi`, `data`) VALUES ('$nome','$telefone','$endereco','$email','$bi',CURRENT_DATE)";
