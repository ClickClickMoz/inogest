          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Editar Motorista ClickTaxi</h1>
...
if(isset($_POST['buttonEditar'])){
  ...
  if ($res_1['telefone'] != $telefone){
    ...
    $query_verificar = "select * from motoristaclicktaxi where telefone = '$telefone' ";
...
$query_editar = "UPDATE motoristaclicktaxi set nome = '$nome', telefone = '$telefone', praca = '$praca', provincia = '$provincia', cidade = '$cidade', matricula = '$matricula', cor = '$cor' where id = '$id' ";
...
<?php
  ...
  if(isset($_POST['button'])){
    ...
    $queryVerifica = "select * from motoristaclicktaxi where telefone = '$telefone'";
    ...
    $query = "INSERT INTO `motoristaclicktaxi`(`nome`, `telefone`, `praca`, `provincia`, `cidade`, `matricula`, `cor`, `data`) VALUES ('$nome','$telefone','$praca','$provincia','$cidade','$matricula','$cor',CURRENT_DATE)";
