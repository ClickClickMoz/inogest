										...
										<div class="row">
											...
											<div class="card">
												...
												if(isset($_GET['buttonPesquisar']) and $_GET['txtpesquisar']!=''){
													...
													$queryTabela = "SELECT * FROM `funcionarios` where nome LIKE '$nome' order by nome asc";
												}else{
												$queryTabela = "SELECT * FROM `funcionarios` order by nome asc";
												}
														...
														while($res_1 = mysqli_fetch_array($resultTabela)){
															...
															<tr>
																...
																<a class="btn btn-info" href="
																 		edit-funcionarios.php?func=edita&id=<?php
																			echo $id;
																			?>
																		">
																...
																pages-funcionarios.php?func=deleta&id=<?php
																echo $id;
																?>
																">
																...
																view-funcionarios.php?func=view&id=<?php
																echo $id;
																?>
																">
...
<?php
  ...
  if(isset($_POST['button'])){
    ...
    $queryVerifica = "SELECT * from `funcionarios` where bi = '$bi'";
    ...
    if($rowVerifica > 0){
      echo"<script language='javascript'>window.alert('Funcionario com este BI Ja esta Cadastrado'); </script>";
      exit();
    }


    $query = "insert into `funcionarios`(`nome`, `bi`, `telefone`, `endereco`, `cargo`, `data`) VALUES ('$nome', '$bi', '$telefone','$endereco','$cargo',CURRENT_DATE)";
         ...
         <!-- Modal content-->
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="fornecedor">BI</label>
                 <input type="text" class="form-control mr-2" name="txtbi" id="txtbi" placeholder="Bilhete de Identidade" value="<?php echo $res_1['bi']; ?>" required>
              </div>
              <div class="form-group">
                <label for="id_produto">Telefone</label>
...
if(isset($_POST['buttonEditar'])){
  ...
  if ($res_1['bi'] != $bi){
    ...
    $query_verificar = "select * from funcionarios where bi = '$bi' ";
...
$query_editar = "UPDATE funcionarios set nome = '$nome', bi = '$bi', telefone = '$telefone', endereco = '$endereco', cargo = '$cargo' where id = '$id' ";
